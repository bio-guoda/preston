...
public class DereferencerContentAddressedTarGZTest {
    ...
    public void pickHashFromTarball() throws IOException {
        ...
        try (InputStream is = getDerefTarGZ().dereference(RefNodeFactory.toIRI("tgz:https://example.com/preston-1a.tar.gz!/1a/57/1a57e55a780b86cff38697cf1b857751ab7b389973d35113564fe5a9a58d6a99"))) {
            assertNotNull(is);
    ...
    public void missingHashExistingTar() throws IOException {
        assertNull(getDerefTarGZ().dereference(RefNodeFactory.toIRI("tgz:https://example.com/preston-1a.tar.gz!/1a/57/1a57e55a780b86cff38697cf1b857751ab7b389973d35113564fe5a9a58d6a00")));
    }

    @Test
    public void existingHashMissingTar() throws IOException {
        assertNull(getDerefTarGZ().dereference(RefNodeFactory.toIRI("tgz:https://example.com/preston-2a.tar.gz!/1a/57/1a57e55a780b86cff38697cf1b857751ab7b389973d35113564fe5a9a58d6a00")));
    }

    public DereferencerContentAddressedTarGZ getDerefTarGZ() {
