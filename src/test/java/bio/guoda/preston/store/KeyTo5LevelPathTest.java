...
public class KeyTo5LevelPathTest {
    ...
    public void toPath() {
        ...
        URI actual = new KeyTo5LevelPath(URI.create("some:///")).toPath(hash.getIRIString());
    ...
    public void generatePathFromUUID() {
        assertThat(new KeyTo5LevelPath(URI.create("some:///")).toPath("hash://sha256/3fc9b689459d738f8c88a3a48aa9e33542016b7a4052e001aaa536fca74813cb"),
