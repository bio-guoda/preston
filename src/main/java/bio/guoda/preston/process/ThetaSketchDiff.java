...
public class ThetaSketchDiff extends ProcessorReadOnly implements Closeable {

    private Map<String, String> encounteredThetaSketches = new TreeMap<>();

    public ThetaSketchDiff(BlobStoreReadOnly blobStoreReadOnly, StatementsListener listener) {
