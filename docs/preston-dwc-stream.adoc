...
preston-dwc-stream - Extract records from DarwinCore archives in line-json
...
*preston dwc-stream* [*--disable-archive-discovery*] [*--no-cache*] [*--no-progress*]
