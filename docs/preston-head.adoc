...
preston-head - shows most recent provenance log version/hash
...
*preston head* [*--disable-archive-discovery*] [*--no-cache*] [*--no-progress*]
             [*-a*=_<hashType>_] [*-d*=_<depth>_] [*--data-dir*=_<dataDir>_] [*-l*=_<logMode>_]
