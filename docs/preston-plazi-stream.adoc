...
preston-plazi-stream - transforms plazi treatment xml into json stream 
...
*preston plazi-stream* [*--disable-archive-discovery*] [*--no-cache*] [*--no-progress*]
