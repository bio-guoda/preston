...
```console
sudo sh -c '(curl -L https://github.com/bio-guoda/preston/releases/download/0.7.8/preston.jar) > /usr/local/bin/preston && chmod +x /usr/local/bin/preston && preston config-manpage' && preston version
```
...
sudo apt update
sudo apt upgrade
curl -L https://github.com/bio-guoda/preston/releases/download/0.7.8/preston.deb > preston.deb
