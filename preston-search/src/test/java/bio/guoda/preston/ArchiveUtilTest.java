...
public class ArchiveUtilTest {
    ...
    private static final String INDEX_TAR_GZ = "/bio/guoda/preston/index/tiny-lucene-index.tar.gz";
    private static final String INDEX_UNPACKED = "/bio/guoda/preston/index/tiny-lucene-index";
    ...
    public void copyDirectoryToBlobstoreAsTarGz() throws IOException {
        ...
        assertThat(version.getIRIString(), is("hash://sha256/a9079d20fcec50ad8555bdce284fd720451888ca356b77977dc5beb6bf10073e"));
    }
