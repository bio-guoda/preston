...
@CommandLine.Command(
        name = "mbd-stream",
        description = "Stream Museum for Biological Diversity (MBD) Database Pages into line-json"
)
public class CmdMBDStream extends LoggingPersisting implements Runnable {
    ...
    public void run(BlobStoreReadOnly blobStoreReadOnly) {
        ...
        MBDPageExtractor textMatcher = new MBDPageExtractor(
                this,
                blobStoreReadOnly,
                getOutputStream(),
                listener);
