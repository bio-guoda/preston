...
@CommandLine.Command(
        name = "genbank-stream",
        aliases = {"gb-stream"},
        description = "Stream genbank accession records into line-json"
)
public class CmdGenBankStream extends LoggingPersisting implements Runnable {
    ...
    public void run(BlobStoreReadOnly blobStoreReadOnly) {
        ...
        GenBankFlatFileExtractor textMatcher = new GenBankFlatFileExtractor(
                this,
                blobStoreReadOnly,
                getOutputStream(),
                listener);
