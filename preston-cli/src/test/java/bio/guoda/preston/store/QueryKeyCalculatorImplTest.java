...
public class QueryKeyCalculatorImplTest {
    ...
    public void calculateKey() {
        ...
        IRI iri = new QueryKeyCalculatorImpl().calculateKeyFor(Pair.of(publisher, version));
    ...
    public void calculateRootArchiveQueryKey() {
        IRI iri = new QueryKeyCalculatorImpl().calculateKeyFor(
    ...
    public void calculateRootURN_UUID_ArchiveQueryKey() {
        IRI iri = new QueryKeyCalculatorImpl()
