...
public class HashGeneratorTikaTLSHTest {
    ...
    public void calculateLTSHash() throws IOException {
        IRI hash = new HashGeneratorTikaTLSH().hash(getClass().getResourceAsStream(DWCA));
        assertThat(hash.getIRIString(), is("hash://tika-tlsh/532a4237d1782aa7576f40d213f91ce46b1fb886498bebcedc507680db323a9415f"));
    }

    @Test
    public void calculateLTSHashDifferentRepackagedBinary() throws IOException {
        IRI hash = new HashGeneratorTikaTLSH().hash(getClass().getResourceAsStream(DWCA));
        IRI hashRepackaged = new HashGeneratorTikaTLSH().hash(getClass().getResourceAsStream(DWCA_REPACKAGED));
    ...
    public void inputStreamClosed() throws IOException {
        ...
        IRI hash = new HashGeneratorTikaTLSH().hash(resourceAsStream1);
        assertThat(hash.getIRIString(), is("hash://tika-tlsh/532a4237d1782aa7576f40d213f91ce46b1fb886498bebcedc507680db323a9415f"));
