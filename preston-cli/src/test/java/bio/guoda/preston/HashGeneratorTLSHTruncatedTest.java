...
public class HashGeneratorTLSHTruncatedTest {
    ...
    public void calculateLTSHashTooShort() throws IOException {
        new HashGeneratorTLSHTruncated().hash(IOUtils.toInputStream("hello", StandardCharsets.UTF_8));
    }

    @Test
    public void calculateLTSHash() throws IOException {
        IRI hash = new HashGeneratorTLSHTruncated().hash(getClass().getResourceAsStream(DWCA));
    ...
    public void calculateLTSHashDifferentRepackagedBinary() throws IOException {
        IRI hash = new HashGeneratorTLSHTruncated().hash(getClass().getResourceAsStream(DWCA));
        IRI hashRepackaged = new HashGeneratorTLSHTruncated().hash(getClass().getResourceAsStream(DWCA_REPACKAGED));
    ...
    public void inputStreamClosed() throws IOException {
        ...
        IRI hash = new HashGeneratorTLSHTruncated().hash(resourceAsStream1);
        assertThat(hash.getIRIString(), is("hash://tlsh/423681883b2b6f3366674b3914a9142a378ad1f41f6641bc84cfa30bb715d7dedc8"));
