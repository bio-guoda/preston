...
@CommandLine.Command(
        name = "taxonworks-stream",
        aliases = {"tw-stream"},
        description = "Stream TaxonWorks metadata into line-json"
)
public class CmdTaxonWorksStream extends LoggingPersisting implements Runnable {
