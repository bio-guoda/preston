...
public class QueryKeyCalculatorBackwardCompatibleTest {
    ...
    public void calculateKey() {
        ...
        IRI iri = new QueryKeyCalculatorBackwardCompatible(HashType.sha256).calculateKeyFor(Pair.of(publisher, version));
        assertThat(iri.getIRIString(),
                is("hash://sha256/a21d81acb039ca8daa013b4eebe52d5eda4f23d29c95d0f04888583ca5c8af4e"));
    }

    @Test
    public void calculateKeyMD5() {
        IRI publisher = RefNodeFactory.toIRI("https://search.idigbio.org/v2/search/publishers");
        IRI version = RefNodeFactory.toIRI("http://purl.org/pav/hasVersion");

        assertThat(HexaStoreImpl.calculateHashFor(publisher, HashType.md5).getIRIString(),
                is("hash://md5/c725b6cf2a569bf818edfa0368f5ba36"));

        assertThat(HexaStoreImpl.calculateHashFor(version, HashType.md5).getIRIString(),
                is("hash://md5/732edeb29432a020f6d8fbb06a30824b"));

        IRI iri = new QueryKeyCalculatorBackwardCompatible(HashType.md5).calculateKeyFor(Pair.of(publisher, version));
        assertThat(iri.getIRIString(),
                is("hash://md5/f06d67281a24a0582001fbec2a84aab2"));
    }

    @Test
    public void calculateRootArchiveQueryKey() {
        IRI iri = new QueryKeyCalculatorBackwardCompatible(HashType.sha256).calculateKeyFor(
    ...
    public void replaceBiodiversityDatasetGraphURN_UUIDWithOldUUID() {
        ...
        IRI iri = new QueryKeyCalculatorBackwardCompatible(HashType.sha256)
