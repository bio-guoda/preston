...
public class DarkTaxonFileStreamHandlerTest {
    ...
    public void parseReadme() {
        ...
        assertThat(matcher.group("imageFilepath"), Is.is("BMT121/BMT0009397/BMT121_BMT0009397_RAW_Data_01"));
        assertThat(matcher.group("imageFilename"), Is.is("BMT121_BMT0009397_RAW_01_01.tiff"));
    }
