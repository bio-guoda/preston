...
public class KeyTo1LevelZenodoPathByAnchorTest {

    @Test(expected = ContentAlternateException.class)
    public void findAnchoredDepositCandidateMD5AnchorMD5Key() {
        ...
        KeyTo1LevelZenodoPathByAnchor keyTo1LevelZenodoPathByAnchor = new KeyTo1LevelZenodoPathByAnchor(new KeyToPath() {
            @Override
        ...
        try {
            RefNodeFactory.toIRI(keyTo1LevelZenodoPathByAnchor.toPath(RefNodeFactory.toIRI("hash://md5/f5de551a5a7354a8a4ced2dd31a2c4db")));
    ...
    public void findAnchoredDepositCandidateMD5AnchorSHA256Key() {
        ...
        try {
            RefNodeFactory.toIRI(keyTo1LevelZenodoPathByAnchor.toPath(
