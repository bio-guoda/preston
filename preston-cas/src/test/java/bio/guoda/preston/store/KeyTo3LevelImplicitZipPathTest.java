...
public class KeyTo3LevelImplicitZipPathTest {

    @Test
    public void attemptZipPath() {
        KeyToPath keyToLevel = new KeyTo3LevelImplicitZipPath(URI.create("zip:https://example.org/data.zip!/data"), HashType.sha256);
