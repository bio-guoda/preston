...
public class KeyToHashURIPathTest {
    ...
    @Test
    public void single() {
        KeyToPath keyTo1LevelPath = new KeyToHashURI(URI.create("https://example.com/"), HashType.sha256);
    ...
    public void singleMD5() {
        KeyToPath keyTo1LevelPath = new KeyToHashURI(URI.create("https://example.com"), HashType.md5);
