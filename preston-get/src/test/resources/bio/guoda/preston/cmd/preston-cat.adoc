...
cat - get content by their content id (or anchored alias)
...
*cat* [*--disable-archive-discovery*] [*--no-cache*] [*--no-progress*] [*-a*=_<hashType>_]
    [*-d*=_<depth>_] [*--data-dir*=_<dataDir>_] [*-r*=_<provenanceAnchor>_]
